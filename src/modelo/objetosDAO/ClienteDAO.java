...
public class ClienteDAO {
	...
	//METODOS:
		...
		public static boolean editar_datos_cliente(String dni, String dni_nuevo, String pasword_nuevo, String nombre_nuevo, String apellidos_nuevo, int edad_nueva, String estado_nuevo, double cuota_nueva) {
			...
			String modificacion = "UPDATE administrativo SET dni = '" + dni_nuevo + "', pasword = '" + pasword_nuevo + "', nombre = '" + nombre_nuevo + "', apellidos = '" + apellidos_nuevo + "', edad = " + edad_nueva + ", estado_empleo = '" + estado_nuevo + "', cuota = " + cuota_nueva + "' WHERE dni LIKE '" + dni + "';";
